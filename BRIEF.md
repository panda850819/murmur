...
> Drafted 2026-05-11 (Sprint 1 of pivot from `murmur-voice` Tauri/Rust → Swift/SwiftUI/WhisperKit).
> Copied into this repo root 2026-05-11 (Sprint 2 scaffold).
>
> 3 個月實際 scope cap。跟未來 `ROADMAP.md` 衝突時以本檔為準。

- **Status**: scaffold (Sprint 2 完成日, MVP v0.1 work pending)
...
- Authored: 2026-05-11
- Origin: `/sprint murmur-voiceink-pivot-brief` (Sprint 1, product-lead persona)
- Input brief: `murmur-voice/docs/briefs/2026-05-11-voiceink-based-pivot.md`
- Scaffold: `/sprint murmur-voiceink-repo-bootstrap` (Sprint 2, eng-lead persona, 2026-05-11)
- Brain refs:
  - `decisions/2026-05-11-murmur-to-whisperkit-pivot.md`
  - `sessions/2026-05-11-murmur-voiceink-pivot-brief-sprint.md`
  - `learnings/patterns/no-hour-budgets-for-personal-briefs.md`
